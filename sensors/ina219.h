/**
 * This is the helper file for the INA219 Sensor. The sensor reads power from the Waveshare 3S UPS.
 * 
*/
...
class INA219 {
public:
  INA219(const char *device, uint8_t addr = INA219_ADDRESS);
  void begin();
